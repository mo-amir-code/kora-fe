...
const CreateTemplateCard = () => {
  return (
    <button className="flex flex-col items-center justify-center gap-4 p-8 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-800 bg-transparent hover:border-brand-500/50 hover:bg-brand-500/5 dark:hover:bg-brand-500/10 transition-all duration-300 group min-h-[250px]">
