...
export const PaymentStats: React.FC<PaymentStatsProps> = ({ stats }) => {
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: LuZap,
      description: 'Deal to bank clearance',
    ...
    },
    {
      ...
      description: overdueCount > 0 ? `${overdueCount} overdue ${overdueCount === 1 ? 'deal' : 'deals'} needing follow-up` : 'All deals up to date',
    ...
    },
    {
      ...
      icon: LuChartPie,
      description: `Collected vs total deal value`,
