  ...
  return (
    <div className="flex flex-col gap-8 min-h-screen bg-white dark:bg-gray-900 transition-colors p-4 sm:p-0">
      ...
      <div className="flex w-full items-center justify-end">
        <button className="flex items-center gap-2 rounded-xl bg-gray-900 dark:bg-white px-6 py-2.5 text-xs font-bold text-white dark:text-gray-900 shadow-xl transition-all hover:opacity-90 active:scale-95 uppercase tracking-widest">
